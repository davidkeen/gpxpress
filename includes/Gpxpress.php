...
class Gpxpress {
	...
	public function admin_init() {
		...
		add_settings_field( 'showstart', 'Show start marker', array(
			$this,
			'showstart_input'
		), 'gpxpress', 'general' );
		add_settings_field( 'showfinish', 'Show finish marker', array(
			$this,
			'showfinish_input'
		), 'gpxpress', 'general' );
	}
	...
	public function admin_menu() {
		add_options_page( 'GPXpress Options', 'GPXpress', 'manage_options', 'gpxpress', array(
			$this,
			'options_page'
		) );
	}
