 ...
 * The 'width' and 'height' parameters should give the width and height of the map in pixels. (Default 600x400)
...
function gpxpress_gpxpress_shortcode_handler($atts) {
    ...
    extract(shortcode_atts(array('src' => null, 'width' => 600, 'height' => 400), $atts));
